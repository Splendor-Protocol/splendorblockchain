...
contract Params {
    ...
    address
        public constant WalletBlocklistAddr = 0x0000000000000000000000000000000000001007;
    ...
    modifier onlyWalletBlocklistContract() {
        require(msg.sender == WalletBlocklistAddr, "WalletBlocklist contract only");
        _;
    }

    modifier onlyAdmin() {
        require(msg.sender == admin || admins[msg.sender], "Admin only");
        _;
    }
    ...
    function setAdmin(address _admin) external onlyAdmin {
        ...
        admin = _admin;
        admins[_admin] = true;
        emit AdminTransferred(previousAdmin, _admin);
    }
